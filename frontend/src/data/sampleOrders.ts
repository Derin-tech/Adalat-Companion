...
export const SAMPLE_ORDERS: SampleOrder[] = [
  {
    ...
    plainSummary: {
      ...
      ml: "2026 ജനുവരി 1 മുതൽ ഭാര്യക്ക് (ഹർജിക്കാരി) പ്രതിമാസം ₹10,000 ഇടക്കാല ജീവനാംശമായി നൽകാൻ ഭർത്താവിനോട് (എതിർകക്ഷി) കോടതി ഉത്തരവിട്ടു. കേസ് നടക്കുന്ന സമയത്ത് ജീവിതച്ചെലവിനായി ഈ തുക എല്ലാ മാസവും 5-ാം തീയതിക്കകം അവരുടെ ബാങ്ക് അക്കൗണ്ടിൽ നൽകണം. അടുത്ത വിചാരണ 2026 മാർച്ച് 15-ന് നടക്കും."
    },
    clauses: {
      en: [
        {
      ...
      ml: [
        {
          id: "c1",
          originalText: "The Respondent is hereby directed to remit a sum of ₹10,000/- per mensum towards the interim maintenance of the Petitioner.",
          plainText: "ഭർത്താവ് (എതിർകക്ഷി) അടിസ്ഥാന ജീവിതച്ചെലവുകൾക്കായി എല്ലാ മാസവും ₹10,000 നൽകണം.",
          pageNumber: 1
        },
        {
          id: "c2",
          originalText: "Said remittance shall be made directly into the bank account of the Petitioner on or before the 5th day of every calendar month, commencing from 01.01.2026.",
          plainText: "2026 ജനുവരി 1 മുതൽ എല്ലാ മാസവും 5-ാം തീയതിക്കകം തുക ഭാര്യയുടെ ബാങ്ക് അക്കൗണ്ടിലേക്ക് മാറ്റണം.",
          pageNumber: 1
        },
        {
          id: "c3",
          originalText: "Matter stands adjourned to 15.03.2026 for compliance.",
          plainText: "പണം നൽകിയിട്ടുണ്ടോ എന്ന് പരിശോധിക്കാൻ അടുത്ത വിചാരണ 2026 മാർച്ച് 15 ലേക്ക് നിശ്ചയിച്ചു.",
          pageNumber: 2
        }
      ]
    }
  },
  {
    ...
    plainSummary: {
      ...
      ml: "എതിർകക്ഷിയുടെ സീനിയർ അഭിഭാഷകന് സുഖമില്ലാത്തതിനാൽ ഇന്നത്തെ വിചാരണ കോടതി മാറ്റിവെച്ചു. പ്രധാന സാക്ഷിയെ (PW-1) വിസ്തരിക്കുന്നതിനായി കേസ് അടുത്തതായി 2026 ഏപ്രിൽ 28-ന് പരിഗണിക്കും. നേരത്തെ നൽകിയിട്ടുള്ള ഇടക്കാല ഉത്തരവുകൾ അന്നുവരെ നിലനിൽക്കും."
    },
    clauses: {
      en: [
        {
      ...
      ml: [
        {
          id: "a1",
          originalText: "At the request of learned counsel for the Respondent, who submits that senior counsel is unavailable today due to medical indisposition, the matter stands adjourned to 28.04.2026.",
          plainText: "എതിർകക്ഷിയുടെ അഭിഭാഷകന് സുഖമില്ലാത്തതിനാൽ ഇന്നത്തെ കോടതി വിചാരണ 2026 ഏപ്രിൽ 28 ലേക്ക് മാറ്റി.",
          pageNumber: 1
        },
        {
          id: "a2",
          originalText: "Interim order, if any, to continue till the next date of hearing.",
          plainText: "നേരത്തെ നൽകിയിട്ടുള്ള എല്ലാ കോടതി ഉത്തരവുകളും അടുത്ത വിചാരണ വരെ നിലനിൽക്കും.",
          pageNumber: 1
        }
      ]
    }
  },
  {
    ...
    plainSummary: {
      ...
      ml: "വ്യവസ്ഥകളോടെ അപേക്ഷകന് (രാജേഷ് വർമ്മ) കോടതി ജാമ്യം അനുവദിച്ചു. ₹25,000 ജാമ്യതുക സമർപ്പിച്ചാൽ കസ്റ്റഡിയിൽ നിന്ന് വിട്ടയക്കും. പാസ്‌പോർട്ട് ഹാജരാക്കണം, എല്ലാ തിങ്കളാഴ്ചയും രാവിലെ 10 നും 1 നും ഇടയിൽ പോലീസ് സ്റ്റേഷനിൽ ഹാജരാകണം, സാക്ഷികളെ സ്വാധീനിക്കാൻ പാടില്ല."
    },
    clauses: {
      en: [
        {
      ...
      ml: [
        {
          id: "b1",
          originalText: "Applicant shall be released on bail upon executing a personal bond of ₹25,000/- with one solvent surety of like amount.",
          plainText: "₹25,000 ബോണ്ടും ഒരു ജാമ്യക്കാരനെയും ഹാജരാക്കിയ ശേഷം പ്രതിക്ക് ജയിൽ മോചിതനാകാം.",
          pageNumber: 1
        },
        {
          id: "b2",
          originalText: "Applicant shall surrender his passport before the Investigating Officer within 48 hours of release.",
          plainText: "ജയിലിൽ നിന്ന് മോചിതനായി 2 ദിവസത്തിനകം (48 മണിക്കൂർ) പാസ്‌പോർട്ട് അന്വേഷണ ഉദ്യോഗസ്ഥന് കൈമാറണം.",
          pageNumber: 1
        },
        {
          id: "b3",
          originalText: "Applicant shall mark his attendance at police station every Monday between 10:00 AM and 01:00 PM.",
          plainText: "എല്ലാ തിങ്കളാഴ്ചയും രാവിലെ പോലീസ് സ്റ്റേഷനിലെത്തി ഒപ്പിടേണ്ടതാണ്.",
          pageNumber: 2
        }
      ]
    }
